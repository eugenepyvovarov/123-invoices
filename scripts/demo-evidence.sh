...
case "${SCENARIO}" in
  ...
  api-token-settings-management)
    ...
    ;;
  "")
    echo "Usage: ./scripts/demo-evidence.sh {incoming-invoice-review-conversion|rolling-year-period-default|customer-payment-notes-override|api-token-settings-management}" >&2
    exit 2
    ;;
  *)
