...
TOOL_SCHEMAS: dict[str, dict] = {
    ...
    "create_draft_invoice": {"description": "Create a draft invoice through the invoices API.", "input_schema": {"type": "object", "properties": {"invoice": {"type": "object"}}, "required": ["invoice"], "additionalProperties": False}},
    "update_draft_invoice": {"description": "Update a draft invoice through the invoices API after checking finalized-invoice safety.", "input_schema": {"type": "object", "properties": {"invoice_id": {"type": "integer", "minimum": 1}, "invoice": {"type": "object"}}, "required": ["invoice_id", "invoice"], "additionalProperties": False}},
